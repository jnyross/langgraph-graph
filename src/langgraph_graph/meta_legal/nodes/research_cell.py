...
_JURISDICTION_DOMAIN_INSTRUMENTS: dict[tuple[str, str], tuple[str, ...]] = {
    ...
    ("european_union", "youth_safety"): (
        ...
        "Child Sexual Abuse CSAM Regulation proposal COM/2022/209",
    ...
    ("united_states", "youth_safety"): (
        ...
        "NCMEC CyberTipline reporting obligations 18 USC 2258A",
    ...
    ("united_states", "accessibility"): (
        ...
        "Rehabilitation Act Section 508 ICT accessibility",
        "CVAA Twenty-First Century Communications and Video Accessibility Act",
        "E-Government Act Section 508 electronic government",
    ),
    ...
    ("south_korea", "youth_safety"): (
        "Act on Promotion of Information and Communications Network Utilization and Information Protection Network Act Korea",
        "Korea youth protection online",
        "Network Act illegal content Korea",
    ),
